...
function ieBuster(options) {
  ...
  if (ieBusterUserAgentCheck()) {
    ...
    ieBusterApp.innerHTML =
      '<div style="width: 100%; max-width:700px; margin: 0 auto; padding: 16px 20px; background-color: #fff; box-shadow: rgba(0, 0, 0, 0.4) 0px 0px 5px 0px; box-sizing: border-box; font-family: SegoeUI, Meiryo, sans-serif;">' +
